                            ...
                            <form method="post" action="${appURL}/signup">
                                ...
                                <div class="mb-4">
                                    <div class="form-check">
                                        <input type="checkbox" <c:if test="${results.terms eq 'agree'}">checked</c:if> class="<c:if test="${not empty results.termsOfServiceError}">is-invalid</c:if> form-check-input" id="checkbox-1" name="checkbox-1" value="agree">
                                ...
                                <!-- DOB -->
                                <div class="mb-4">
                                    <label for="inputDOB" class="form-label">Email address *</label>
                                    <div class="input-group input-group-lg">
