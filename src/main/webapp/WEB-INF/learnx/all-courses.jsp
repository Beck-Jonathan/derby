                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xxl-6">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" <c:if test="${fn:contains(categoryFilter,categories[0].id) }"> checked   </c:if> type="checkbox" name="category"  id="flexCheckDefault9" value="${categories[0].id}">
                                                <label class="form-check-label" for="flexCheckDefault9">${categories[0].name} (${categories[0].numCourses})</label>
                                            </div>
                                            <!-- Checkbox -->
                                            <div class="form-check">
                                                <input class="form-check-input" <c:if test="${fn:contains(categoryFilter,categories[1].id) }"> checked   </c:if>type="checkbox"  name="category" id="flexCheckDefault10" value="${categories[1].id}">
                                                <label class="form-check-label" for="flexCheckDefault10">${categories[1].name} (${categories[1].numCourses})</label>
                                            </div>
                                            <!-- Checkbox -->
                                            <div class="form-check">
                                                <input class="form-check-input" <c:if test="${fn:contains(categoryFilter,categories[2].id) }"> checked   </c:if> type="checkbox" name="category" id="flexCheckDefault11" value="${categories[2].id}">
                                                <label class="form-check-label" for="flexCheckDefault11">${categories[2].name} (${categories[2].numCourses})</label>
                                            </div>
                                            <!-- Checkbox -->
                                            <div class="form-check">
                                                <input class="form-check-input" <c:if test="${fn:contains(categoryFilter,categories[3].id) }"> checked   </c:if> type="checkbox" name="category" id="flexCheckDefault12" value="${categories[3].id}">
                                ...
                                <div class="card card-body shadow p-4 mb-4">
                                    ...
                                    <ul class="list-inline mb-0">
                                        ...
                                        <li class="list-inline-item mb-2">
                                            <input type="radio"  <c:if test="${skillFilter eq ''}">checked</c:if>  name="skill-level" value="" class="btn-check" id="btn-check-12">
                                            <label class="btn btn-light btn-primary-soft-check" for="btn-check-12">All levels</label>
                                        </li>
                                        <!-- Item -->
                                        <li class="list-inline-item mb-2">
                                            <input type="radio" <c:if test="${skillFilter eq 'beginner'}">checked</c:if>  name="skill-level" value="beginner" class="btn-check" id="btn-check-9">
                                            <label class="btn btn-light btn-primary-soft-check" for="btn-check-9">Beginner</label>
                                        </li>
                                        <!-- Item -->
                                        <li class="list-inline-item mb-2">
                                            <input type="radio" <c:if test="${skillFilter eq 'intermediate'}">checked</c:if>  name="skill-level" value="intermediate" class="btn-check" id="btn-check-10">
                                            <label class="btn btn-light btn-primary-soft-check" for="btn-check-10">Intermediate</label>
                                        </li>
                                        <!-- Item -->
                                        <li class="list-inline-item mb-2">
                                            <input type="radio" <c:if test="${skillFilter eq 'advanced'}">checked</c:if>  name="skill-level" value="advanced" class="btn-check" id="btn-check-11">
